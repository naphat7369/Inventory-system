      ...
      <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center mb-8 gap-4 w-full">
        ...
        <div className="flex flex-wrap gap-3 w-full md:w-auto">
          ...
          <Link 
            ...
            target="_blank"
            className="flex items-center gap-2 bg-gray-800 dark:bg-slate-800 text-white px-4 py-2 rounded-lg font-medium hover:bg-gray-900 dark:hover:bg-slate-700 transition-colors"
          >
          ...
          {session?.role === 'ADMIN' && (
            <>
              <Link 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors border ${trash === 'true' ? 'bg-gray-200 text-gray-800 dark:text-gray-200 hover:bg-gray-300 border-gray-300 dark:border-slate-600' : 'bg-red-50 text-red-600 hover:bg-red-100 border-red-200 dark:bg-red-950/40 dark:text-red-400 dark:border-red-900/50'}`}
              >
